      ...
      <div className="container">
        <div className="max-w-3xl mx-auto mb-16">
          <div className="mt-6 mb-6 lg:mb-12">
            <h1>
              <span className={legalTextStyling.header}>Acceptable Use</span>
            </h1>
            <p>
            ...
            <p className={legalTextStyling.body}>
              ...
              Conditions ("Legal Terms") and should therefore be read alongside
              our main Legal Terms:{" "}
              <a href="/terms-and-conditions" className={legalTextStyling.link}>
                Terms and Conditions.
              </a>
              If you do not agree with these Legal Terms, please refrain from
              using our Services. Your continued use of our Servicesimplies
            ...
            <ul className={legalTextStyling.ul}>
              ...
              <li>
                forms, materials, consent tools, comments, post, and all other
                content available on the services ("Content")
              </li>
            </ul>
            <h1 className={legalTextStyling.title}> Who We Are</h1>
            <p className={legalTextStyling.body}>
            ...
            <h1 className={legalTextStyling.title}>Use of The Services</h1>
            <p className={legalTextStyling.body}>
            ...
            <ul className={`${legalTextStyling.ul} mb-20`}>
              <li>
                Systemically retrieve data or other consent from the Services to
                create or complie, directly or indirectly, a collection,
              ...
              <li>
                Disparagr, tarnish, or otherwise harm, in our opinion, us and/or
                the Services.
              </li>
              <li>
