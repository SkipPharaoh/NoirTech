    ...
    <footer className="bg-gray-50 text-black" style={bg}>
        ...
        <section className="lg:col-span-7">
          <div className="container mx-auto md:px-20 py-16 md:pb-0 text-center h-full align-middle">
            ...
            <p className="text-base">
              We'll be in your inbox every time we release a new blog post with
              the top information help you become a professional techie.
            </p>
          </div>
        </section>
        <BlogSubscription />
      ...
      <div className="w-full">
        <div className="container">
          <div className="py-6 grid gap-6 lg:grid-cols-2">
