      ...
      <div className="container">
        <div className="max-w-3xl mx-auto mb-16">
          <div className="mt-6 mb-6 lg:mb-12">
            <h1>
              <span className="my-2 block text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <ol className="list-decimal list-outside ml-6">
              {TOSMenu.map((item) => (
                <li key={item.name} className="my-4">
                  <a href={item.link} className="underline text-blue-600">
                    {item.name}
                  </a>
                </li>
              ))}
            </ol>
            <h2 id="section1" className="font-bold text-xl my-6">
            ...
            <h2 id="section2" className="font-bold text-xl my-6">
              2. Interpretation and Definitions
            </h2>
            <h3 className="font-bold text-lg my-4">Interpretation</h3>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h3 className="font-bold text-lg my-4">Definitions</h3>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section3" className="font-bold text-xl my-6">
              3. Acknowledgment
            </h2>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section4" className="font-bold text-xl my-6">
            ...
            <h2 id="section5" className="font-bold text-xl my-6">
              5. Termination
            </h2>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section6" className="font-bold text-xl my-6">
            ...
            <h2 id="section7" className="font-bold text-xl my-6">
            ...
            <h2 id="section8" className="font-bold text-xl my-6">
              8. Governing Law
            </h2>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section9" className="font-bold text-xl my-6">
            ...
            <h2 id="section10" className="font-bold text-xl my-6">
            ...
            <h2 id="section11" className="font-bold text-xl my-6">
            ...
            <h2 id="section12" className="font-bold text-xl my-6">
              12. Severability and Waiver
            </h2>
            <h3 className="font-bold text-lg my-4">Severability</h3>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h3 className="font-bold text-lg my-4">Waiver</h3>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section13" className="font-bold text-xl my-6">
            ...
            <h2 id="section14" className="font-bold text-xl my-6">
              14. Entire Agreement
            </h2>
            <p className="leading-6 tracking-[-0.0125em] my-4">
            ...
            <h2 id="section15" className="font-bold text-xl my-6">
              15. Service Contact
            </h2>
            <p className="leading-6 tracking-[-0.0125em] my-4">
